...
class Hotel extends StatelessWidget//// StateWidget을 상속받은 클래스로, 숙소 화면 구현
    {
  @override
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (context, index) =>
                      Padding(
                        ...
                        child: HotelList_Type(hotel_picture[index]['imagePath'], hotel_picture[index]['placeName'], hotel_picture[index]['placeSummary'], context ),
                      )
              ),
            ),
          ],
  ...
  Widget HotelList_Type(String imagePath, String placeName,
      String touristPlaceCount,  context) //숙소 목록 아이템을 구성하는 위젯을 반환
  {
    return GestureDetector//클릭할 때의 동작을 정의
      (
      onTap: () => {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => HotelDetail(imagePath)))
      },
